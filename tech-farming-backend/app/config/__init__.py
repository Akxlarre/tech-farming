...
escribir_dato(sensor_id="S003", parametro="N", valor=69.5)
escribir_dato(sensor_id="S003", parametro="Humedad", valor=70.0)
escribir_dato(sensor_id="S004", parametro="Potasio", valor=9.8)
