import {
  ...
  @Component({
    ...
    template: `
      ...
      <div
        #drawer
        class="fixed top-0 right-0 h-full bg-base-100 shadow-xl z-50 w-[800px] sm:w-1/2 md:w-1/3 transform transition-transform duration-300 ease-in-out overflow-auto border-l border-base-300"
